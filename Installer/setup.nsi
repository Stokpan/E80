...
; Installation folder from registry if previously installed
...
Section "Portable requirements" SecCore
	...
	; Copy files (SetOutPath = where to copy, File = what to copy)
...
Section "Register .e80asm files" SecAssoc
	...
	; Refresh Icons without adding the annoying Internet Explorer link on Accessories
	${RefreshShellIcons}
SectionEnd
