...
3. Open `Boards\Gowin_TangPrimer25K\E80.cst` in a text editor and connect the components according to the Pin Assignments section.
   <br><img src="TangPrimer25K.jpg" width="1400" height="702">
   <br><img src="TangPrimer25Kclose.jpg" width="1200" height="458">
...
7. The LED Matrix test will start running indefinitely.