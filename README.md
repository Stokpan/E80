...
* _Wide walls_, as it was synthesized on common EDAs, tested on low-cost FPGAs, scripted for libre or free simulators, and provides the complete source code for everything: from the CFG grammar and the assembler, to the VHDL code, constraints, automation scripts etc.

This makes it easy to use, capable of running pretty complex and realistic programs, and can be used (or modified) in a variety of scenarios from the lab to the classroom.
...
## Example 1 - One-click simulation with GHDL
...
<p align="center"><img width="586" height="552" alt="Source code as it appears in the editor" src="https://github.com/user-attachments/assets/580c1a76-291c-4321-887f-6888afcf5774" /></p>
...
Press F5. The editor will automatically assemble the code, save the VHDL to Firmware.vhd, compile the E80 Computer testbench with GHDL, and launch GTKWave. You should see the following waveform showing the RAM locations 25-31 changing from lowercase to uppercase:
...
You can also press F7 to view the generated `Firmware.vhd` file:
...
To run the test, paste the following program into the editor and hit F7. This will automatically update `Firmware.vhd` with your new code.
