<a href="#"><img align="left" alt="E80" src="Images/e80icon.svg" width="100" height="100" /></a> E80 is a simple CPU in structural VHDL, originally developed for [my undergraduate thesis](https://apothesis.eap.gr/archive/item/222454) as a Papertian Microworld, to evoke the powerful idea of program execution on logic gates and flip-flops through a low floor of one-click simulation, and a high ceiling of a textbook-complete instruction set.<br clear="left" />
...
**<a href="Boards/Gowin_TangPrimer25K/README.md">Tang Primer 25K (Gowin FPGA Designer) <br/> <img src="Boards/Gowin_TangPrimer25K/Tang%20Primer%2025K.jpg" width="400" height="200" /></a>**
