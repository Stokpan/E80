...
| 21 | 01000rrr | nnnnnnnn | 4r nn | ROR r,n       | r>>n (r<<8-n)         |  ZS   |
| 22 | 01001000 | 0rrr0rrr | 48 rr | ROR r1,r2     | r1>>r2 (r1<<8-r2)     |  ZS   |
| 23 | 01010rrr | nnnnnnnn | 5r nn | AND r,n       | r ← r&n               |  ZS   |
| 24 | 01011000 | 0rrr0rrr | 58 rr | AND r1,r2     | r1 ← r1&r2            |  ZS   |
| 25 | 01100rrr | nnnnnnnn | 6r nn | OR r,n        | r ← r|n               |  ZS   |
| 26 | 01101000 | 0rrr0rrr | 68 rr | OR r1,r2      | r1 ← r1|r2            |  ZS   |
| 27 | 01110rrr | nnnnnnnn | 7r nn | XOR r,n       | r ← r^n               |  ZS   |
| 28 | 01111000 | 0rrr0rrr | 78 rr | XOR r1,r2     | r1 ← r1^r2            |  ZS   |
...
| 33 | 10100rrr |          | Ar    | RSHIFT r      | (r,C)>>1; V ← S flip  | CZSV  |
| 34 | 10110rrr | nnnnnnnn | Br nn | CMP r,n       | SUB, discard result   | CZSV  |
| 35 | 10111000 | 0rrr0rrr | B8 rr | CMP r1,r2     | SUB, discard result   | CZSV  |
| 36 | 11000rrr |          | Cr    | LSHIFT r      | (C,r)<<1; V ← S flip  | CZSV  |
| 37 | 11010rrr | nnnnnnnn | Dr nn | BIT r,n       | AND, discard result   |  ZS   |
...
If you have installed ModelSim, you can press F8 to simulate into it. Subsequent presses of F8 will update the existing ModelSim window:
